...
#if !(EIGEN_COMP_CLANG && ((EIGEN_COMP_CLANG < 309) || (defined(__apple_build_version__) && (__apple_build_version__ < 9000000))) || EIGEN_COMP_GNUC_STRICT && EIGEN_COMP_GNUC < 49)
...
#if EIGEN_MAX_CPP_VER >= 11 && \
    ((defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901)) || (defined(__GNUC__) && defined(_GLIBCXX_USE_C99)) || (defined(_LIBCPP_VERSION) && !defined(_MSC_VER)) || (EIGEN_COMP_MSVC >= 1900) || defined(SYCL_DEVICE_ONLY))
...
#define EIGEN_HAS_STD_INVOKE_RESULT 0
    ...
    (__has_feature(cxx_alignas) || EIGEN_HAS_CXX14 || (EIGEN_COMP_MSVC >= 1800) || (EIGEN_GNUC_AT_LEAST(4, 8)) || (EIGEN_COMP_CLANG >= 305) || (EIGEN_COMP_ICC >= 1500) || (EIGEN_COMP_PGI >= 1500) || (EIGEN_COMP_SUNCC >= 0x5130))
...
#if EIGEN_MAX_CPP_VER >= 11 && (EIGEN_HAS_CXX11 || EIGEN_COMP_MSVC >= 1700) && ((!EIGEN_COMP_GNUC_STRICT) || EIGEN_GNUC_AT_LEAST(5, 1)) && ((!defined(__GLIBCXX__)) || __GLIBCXX__ > 20150626)
...
#if EIGEN_MAX_CPP_VER >= 11 && (EIGEN_COMP_CXXVER >= 11) && (!defined(__NVCC__) || !EIGEN_ARCH_ARM_OR_ARM64 || (EIGEN_COMP_NVCC >= 80000))
...
#if EIGEN_MAX_CPP_VER >= 11 && ((EIGEN_COMP_CXXVER > 11) || (EIGEN_COMP_CXXVER == 11) && (EIGEN_COMP_GNUC_STRICT || EIGEN_COMP_CLANG || EIGEN_COMP_MSVC || EIGEN_COMP_ICC) && (EIGEN_ARCH_i386_OR_x86_64) && (EIGEN_OS_GNULINUX || EIGEN_OS_WIN_STRICT || EIGEN_OS_MAC))
...
#if EIGEN_MAX_CPP_VER >= 11 && \
    ((EIGEN_COMP_CXXVER > 11) || ((EIGEN_COMP_CXXVER == 11) && (EIGEN_COMP_GNUC_STRICT || EIGEN_COMP_CLANG || EIGEN_COMP_MSVC || EIGEN_COMP_ICC >= 1400)))
...
#if EIGEN_MAX_CPP_VER >= 11 && \
    (__has_feature(cxx_noexcept) || (EIGEN_COMP_CXXVER > 11) || ((EIGEN_COMP_CXXVER == 11) && (EIGEN_COMP_GNUC_STRICT || EIGEN_COMP_CLANG || EIGEN_COMP_MSVC || EIGEN_COMP_ICC >= 1400)))
...
#if EIGEN_MAX_CPP_VER >= 11 && \
    (__has_feature(cxx_atomic) || (EIGEN_COMP_CXXVER > 11) || ((EIGEN_COMP_CXXVER == 11) && (EIGEN_COMP_MSVC == 0 || EIGEN_COMP_MSVC >= 1700)))
...
#if EIGEN_MAX_CPP_VER >= 17 && EIGEN_COMP_CXXVER >= 17 && ((EIGEN_COMP_MSVC >= 1912) || (EIGEN_GNUC_AT_LEAST(7, 0)) || ((!defined(__apple_build_version__)) && (EIGEN_COMP_CLANG >= 500)) || ((defined(__apple_build_version__)) && (__apple_build_version__ >= 10000000)))
...
#define EIGEN_MAKE_CWISE_BINARY_OP(METHOD, OPNAME)                                                                                                                                         \
    template <typename OtherDerived>                                                                                                                                                       \
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const EIGEN_CWISE_BINARY_RETURN_TYPE(Derived, OtherDerived, OPNAME)(METHOD)(const EIGEN_CURRENT_STORAGE_BASE_CLASS<OtherDerived>& other) const { \
...
#define EIGEN_MAKE_SCALAR_BINARY_OP_ONTHERIGHT(METHOD, OPNAME)                                                                                                                                                                                                                   \
    ...
    EIGEN_MSVC10_WORKAROUND_BINARYOP_RETURN_TYPE(const EIGEN_EXPR_BINARYOP_SCALAR_RETURN_TYPE(Derived, typename internal::promote_scalar_arg<Scalar EIGEN_COMMA T EIGEN_COMMA EIGEN_SCALAR_BINARY_SUPPORTED(OPNAME, Scalar, T)>::type, OPNAME))(METHOD)(const T& scalar) const { \
