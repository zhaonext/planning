...
/** \returns an expression of \a expr with each coeff incremented by the constant \a scalar
  ...
  */
template <typename T>
friend const CwiseBinaryOp<internal::scalar_sum_op<T, Scalar>, Constant<T>, Derived> operator+(const T& scalar, const StorageBaseType& expr);
#endif
...
/** \returns an expression of the constant matrix of value \a scalar decremented by the coefficients of \a expr
  ...
  */
template <typename T>
friend const CwiseBinaryOp<internal::scalar_difference_op<T, Scalar>, Constant<T>, Derived> operator-(const T& scalar, const StorageBaseType& expr);
#endif
...
/**
    ...
    */
template <typename T>
friend inline const CwiseBinaryOp<internal::scalar_quotient_op<T, Scalar>, Constant<T>, Derived>
