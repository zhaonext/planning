...
EIGEN_DEVICE_FUNC inline const typename Derived::Scalar bruteforce_det3_helper(const MatrixBase<Derived>& matrix, int a, int b, int c) {
...
protected:
    static EIGEN_DEVICE_FUNC
        Scalar
        det2(const Derived& m, Index i0, Index i1) {
