...
public:
    ...
    enum {
        ...
        IsVectorAtCompileTime = internal::traits<Derived>::RowsAtCompileTime == 1 || internal::traits<Derived>::ColsAtCompileTime == 1,
    ...
    void resize(Index rows, Index cols) {
        ...
        eigen_assert(rows == this->rows() && cols == this->cols() && "DenseBase::resize() does not actually allow to resize.");
    }
    ...
    EIGEN_DEPRECATED const Derived& flagged() const { return derived(); }
    ...
    EIGEN_DEVICE_FUNC inline const typename internal::conditional<Enable, ForceAlignedAccess<Derived>, Derived&>::type forceAlignedAccessIf() const;
    template <bool Enable>
    EIGEN_DEVICE_FUNC inline typename internal::conditional<Enable, ForceAlignedAccess<Derived>, Derived&>::type forceAlignedAccessIf();
    ...
    */
    ...
    typedef typename internal::conditional<(Flags & DirectAccessBit) == DirectAccessBit,
                                           ...
                                           internal::generic_randaccess_stl_iterator<const Derived> >::type const_iterator_type;
...
protected:
    ...
    EIGEN_DEVICE_FUNC DenseBase() {
       ...
       */
        ...
        EIGEN_STATIC_ASSERT((EIGEN_IMPLIES(MaxRowsAtCompileTime == 1 && MaxColsAtCompileTime != 1, int(IsRowMajor)) && EIGEN_IMPLIES(MaxColsAtCompileTime == 1 && MaxRowsAtCompileTime != 1, int(!IsRowMajor))),
