...
public:
    ...
    CwiseNullaryOp(Index rows, Index cols, const NullaryOp& func = NullaryOp())
        ...
        eigen_assert(rows >= 0 && (RowsAtCompileTime == Dynamic || RowsAtCompileTime == rows) && cols >= 0 && (ColsAtCompileTime == Dynamic || ColsAtCompileTime == cols));
    }
...
/** \returns an expression of the X axis unit vector (1{,0}^*)
  ...
  */
template <typename Derived>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const typename MatrixBase<Derived>::BasisReturnType MatrixBase<Derived>::UnitX() { return Derived::Unit(0); }
...
/** \returns an expression of the Y axis unit vector (0,1{,0}^*)
  ...
  */
template <typename Derived>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const typename MatrixBase<Derived>::BasisReturnType MatrixBase<Derived>::UnitY() { return Derived::Unit(1); }
...
/** \returns an expression of the Z axis unit vector (0,0,1{,0}^*)
  ...
  */
template <typename Derived>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const typename MatrixBase<Derived>::BasisReturnType MatrixBase<Derived>::UnitZ() { return Derived::Unit(2); }
...
/** \returns an expression of the W axis unit vector (0,0,0,1)
  ...
  */
template <typename Derived>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const typename MatrixBase<Derived>::BasisReturnType MatrixBase<Derived>::UnitW() { return Derived::Unit(3); }
