...
struct product_triangular_matrix_matrix<Scalar, Index, Mode, LhsIsTriangular,
    ...
    static EIGEN_STRONG_INLINE void run(
        ...
        product_triangular_matrix_matrix<Scalar, Index,
                                         ...
                                         ConjugateLhs,
                                         ColMajor, ResInnerStride>::run(cols, rows, depth, rhs, rhsStride, lhs, lhsStride, res, resIncr, resStride, alpha, blocking);
    }
};
...
EIGEN_DONT_INLINE void product_triangular_matrix_matrix<Scalar, Index, Mode, true,
                                                        LhsStorageOrder, ConjugateLhs,
                                                        RhsStorageOrder, ConjugateRhs, ColMajor, ResInnerStride, Version>::run(Index _rows, Index _cols, Index _depth,
                                                                                                                               const Scalar* _lhs, Index lhsStride,
                                                                                                                               const Scalar* _rhs, Index rhsStride,
    ...
    for (Index k2 = IsLower ? depth : 0;
        ...
        // the part below (lower case) or above (upper case) the diagonal => GEPP
        {
            ...
            for (Index i2 = start; i2 < end; i2 += mc) {
                ...
                gemm_pack_lhs<Scalar, Index, LhsMapper, Traits::mr, Traits::LhsProgress, typename Traits::LhsPacket4Packing, LhsStorageOrder, false>()(blockA, lhs.getSubMapper(i2, actual_k2), actual_kc, actual_mc);
...
struct triangular_product_impl<Mode, LhsIsTriangular, Lhs, false, Rhs, false> {
    ...
    static void run(Dest& dst, const Lhs& a_lhs, const Rhs& a_rhs, const typename Dest::Scalar& alpha) {
        ...
        internal::product_triangular_matrix_matrix<Scalar, Index,
                                                   ...
                                                   (internal::traits<Dest>::Flags & RowMajorBit) ? RowMajor : ColMajor, Dest::InnerStrideAtCompileTime>::run(stripedRows, stripedCols, stripedDepth,                     // sizes
