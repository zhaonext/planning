...
public:
    ...
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR
        Index
        rows() const EIGEN_NOEXCEPT { return (Direction == Vertical ? 1 : m_matrix.rows()); }
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR
        Index
        cols() const EIGEN_NOEXCEPT { return (Direction == Horizontal ? 1 : m_matrix.cols()); }
...
#define EIGEN_MAKE_PARTIAL_REDUX_FUNCTOR(MEMBER, COST, VECTORIZABLE, BINARYOP) \
    ...
    struct member_##MEMBER {                                                   \
        ...
        EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE                                  \
            ResultType                                                         \
            operator()(const XprType& mat) const { return mat.MEMBER(); }      \
...
struct member_lpnorm {
    ...
    template <typename XprType>
    EIGEN_DEVICE_FUNC inline ResultType operator()(const XprType& mat) const { return mat.template lpNorm<p>(); }
};
...
struct member_redux {
    ...
    typedef typename result_of<
        BinaryOp(const Scalar&, const Scalar&)>::type result_type;
    ...
    EIGEN_DEVICE_FUNC inline result_type operator()(const DenseBase<Derived>& mat) const { return mat.redux(m_functor); }
...
protected:
    ...
    EIGEN_DEVICE_FUNC
        ...
        return typename ExtendedType<OtherDerived>::Type(other.derived(),
    ...
    EIGEN_DEVICE_FUNC
        ...
        EIGEN_STATIC_ASSERT(EIGEN_IMPLIES(isVertical, OtherDerived::MaxRowsAtCompileTime == 1),
                            YOU_PASSED_A_COLUMN_VECTOR_BUT_A_ROW_VECTOR_WAS_EXPECTED)
        return typename OppositeExtendedType<OtherDerived>::Type(other.derived(),
...
public:
    ...
    /** \returns a row (or column) vector expression of the norm
      ...
      * \sa DenseBase::norm() */
    template <int p>
    EIGEN_DEVICE_FUNC const typename LpNormReturnType<p>::Type lpNorm() const { return typename LpNormReturnType<p>::Type(_expression()); }
    ...
    * \sa DenseBase::mean() */
    EIGEN_DEVICE_FUNC
    const MeanReturnType mean() const { return sum() / Scalar(Direction == Vertical ? m_matrix.rows() : m_matrix.cols()); }
