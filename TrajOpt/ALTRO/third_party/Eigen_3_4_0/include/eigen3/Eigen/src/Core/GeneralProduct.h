...
struct gemv_dense_selector<OnTheRight, ColMajor, true> {
    ...
    static inline void run(const Lhs& lhs, const Rhs& rhs, Dest& dest, const typename Dest::Scalar& alpha) {
        ...
        if (!MightCannotUseDest) {
            ...
            general_matrix_vector_product<Index, LhsScalar, LhsMapper, ColMajor, LhsBlasTraits::NeedToConjugate, RhsScalar, RhsMapper, RhsBlasTraits::NeedToConjugate>::run(
...
struct gemv_dense_selector<OnTheRight, RowMajor, true> {
    ...
    static void run(const Lhs& lhs, const Rhs& rhs, Dest& dest, const typename Dest::Scalar& alpha) {
        ...
        general_matrix_vector_product<Index, LhsScalar, LhsMapper, RowMajor, LhsBlasTraits::NeedToConjugate, RhsScalar, RhsMapper, RhsBlasTraits::NeedToConjugate>::run(
            actualLhs.rows(), actualLhs.cols(),
            LhsMapper(actualLhs.data(), actualLhs.outerStride()),
...
MatrixBase<Derived>::operator*(const MatrixBase<OtherDerived>& other) const {
    ...
    enum {
        ProductIsValid = Derived::ColsAtCompileTime == Dynamic || OtherDerived::RowsAtCompileTime == Dynamic || int(Derived::ColsAtCompileTime) == int(OtherDerived::RowsAtCompileTime),
