...
public:
    ...
    */
    template <class OtherDerived>
    EIGEN_DEVICE_FUNC inline Scalar dot(const QuaternionBase<OtherDerived>& other) const { return coeffs().dot(other.coeffs()); }
    ...
    * \sa isApprox(), operator!= */
    template <class OtherDerived>
    EIGEN_DEVICE_FUNC inline bool operator==(const QuaternionBase<OtherDerived>& other) const { return coeffs() == other.coeffs(); }
    ...
    * \sa MatrixBase::isApprox() */
    template <class OtherDerived>
    EIGEN_DEVICE_FUNC bool isApprox(const QuaternionBase<OtherDerived>& other, const RealScalar& prec = NumTraits<Scalar>::dummy_precision()) const { return coeffs().isApprox(other.coeffs(), prec); }
    ...
    */
    ...
    EIGEN_DEVICE_FUNC inline
        typename internal::enable_if<internal::is_same<Scalar, NewScalarType>::value, const Derived&>::type
        cast() const {
        return derived();
    }
    ...
    template <typename NewScalarType>
    EIGEN_DEVICE_FUNC inline
        typename internal::enable_if<!internal::is_same<Scalar, NewScalarType>::value, Quaternion<NewScalarType> >::type
        cast() const {
...
public:
    ...
    */
    ...
    /** Copy constructor */
    template <class Derived>
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Quaternion(const QuaternionBase<Derived>& other) { this->Base::operator=(other); }
    ...
    */
    ...
    EIGEN_DEVICE_FUNC explicit inline Quaternion(const Quaternion<OtherScalar, OtherOptions>& other) { m_coeffs = other.coeffs().template cast<Scalar>(); }
