...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    float4
    pdigamma<float4>(const float4& a) {
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    float4
    pzeta<float4>(const float4& x, const float4& q) {
    using numext::zeta;
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    double2
    pzeta<double2>(const double2& x, const double2& q) {
    using numext::zeta;
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    float4
    pigamma<float4>(const float4& a, const float4& x) {
    using numext::igamma;
    return make_float4(
        igamma(a.x, x.x),
        igamma(a.y, x.y),
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    float4
    pigammac<float4>(const float4& a, const float4& x) {
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    float4
    pbetainc<float4>(const float4& a, const float4& b, const float4& x) {
