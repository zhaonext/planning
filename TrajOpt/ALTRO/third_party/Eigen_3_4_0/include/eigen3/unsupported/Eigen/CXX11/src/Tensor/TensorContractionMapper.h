...
struct CoeffLoader {
    ...
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
        typename Tensor::PacketReturnType
        packet(typename Tensor::Index index) const {
...
public:
    ...
    SimpleTensorContractionMapper(const Tensor& tensor,
                                  ...
                                  const contract_t& k_strides) : m_tensor(tensor),
...
public:
    ...
    BaseTensorContractionMapper(const Tensor& tensor,
                                ...
                                const nocontract_t& ij_strides,
                                const contract_t& contract_strides,
                                const contract_t& k_strides) : ParentMapper(tensor, nocontract_strides, ij_strides, contract_strides, k_strides) {}
    ...
    template <typename PacketT, int AlignmentType>
    EIGEN_DEVICE_FUNC
        EIGEN_STRONG_INLINE PacketT
        loadPacket(Index i, Index j) const {
