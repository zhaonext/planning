...
struct generic_k0e<T, float> {
     ...
     */
        ...
        x_le_two = pmadd(
            generic_i0<T, float>::run(x), pnegate(plog(pmul(pset1<T>(0.5), x))), x_le_two);
...
struct generic_k0e<T, double> {
     ...
     */
        ...
        T x_le_two = internal::pchebevl<T, 10>::run(
            pmadd(x, x, pset1<T>(-2.0)), A);
        x_le_two = pmadd(
            generic_i0<T, double>::run(x), pmul(pset1<T>(-1.0), plog(pmul(pset1<T>(0.5), x))), x_le_two);
        x_le_two = pmul(pexp(x), x_le_two);
...
struct generic_k0<T, double> {
     ...
     */
        ...
        T x_le_two = internal::pchebevl<T, 10>::run(
            pmadd(x, x, pset1<T>(-2.0)), A);
        x_le_two = pmadd(
            generic_i0<T, double>::run(x), pnegate(plog(pmul(pset1<T>(0.5), x))), x_le_two);
        x_le_two = pselect(pcmp_le(x, pset1<T>(0.0)), MAXNUM, x_le_two);
        T x_gt_two = pmul(
            pmul(
                pexp(-x),
...
struct generic_y1<T, double> {
     ...
     */
        ...
        x_le_five = pmadd(
            x_le_five, x, pmul(TWOOPI, pmadd(generic_j1<T, double>::run(x), plog(x), pdiv(pset1<T>(-1.0), x))));
