 ...
 */
template <class Func>
Eigen::MatrixXd FiniteDiffJacobian(const Func& f, const VectorXdRef& x, const double eps = 1e-6,
...
Eigen::Matrix<double, ncols, 1> FiniteDiffGradient(const Func& f,
 ...
 */
template <int ncols, class Func>
Eigen::Matrix<double, ncols, ncols> FiniteDiffHessian(const Func& f,
                                                      const Eigen::Matrix<double, ncols, 1>& x,
                                                      const double eps = 1e-4,
                                                      const bool central = true) {
