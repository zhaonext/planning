...
class ContinuousDynamics : public FunctionBase {
 public:
  ...
  virtual void Jacobian(const VectorXdRef& x, const VectorXdRef& u, float t,
                        Eigen::Ref<MatrixXd> jac) = 0;
...
class DiscreteDynamics : public FunctionBase {
 public:
  ...
  virtual void Evaluate(const VectorXdRef& x, const VectorXdRef& u, float t, float h,
                        Eigen::Ref<VectorXd> xdot) = 0;
  virtual void Jacobian(const VectorXdRef& x, const VectorXdRef& u, float t, float h,
                        Eigen::Ref<MatrixXd> jac) = 0;
  virtual void Hessian(const VectorXdRef& x, const VectorXdRef& u, float t, float h,
                       const VectorXdRef& b, Eigen::Ref<MatrixXd> hess) = 0;
