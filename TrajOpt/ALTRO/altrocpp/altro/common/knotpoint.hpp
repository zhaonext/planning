...
class KnotPoint : public StateControlSized<n, m> {
 ...
 public:
  KnotPoint() : StateControlSized<n, m>(n, m), x_(StateVector::Zero()), u_(ControlVector::Zero()) {}
  KnotPoint(const StateVector& x, const ControlVector& u, const float t = 0.0, const float h = 0.0)
      : StateControlSized<n, m>(x.size(), u.size()), x_(x), u_(u), t_(t), h_(h) {}
  KnotPoint(int _n, int _m)
      : StateControlSized<n, m>(_n, _m), x_(StateVector::Zero(_n)), u_(ControlVector::Zero(_m)) {}
  ...
  KnotPoint(const KnotPoint& z)
      : StateControlSized<n, m>(z.n_, z.m_), x_(z.x_), u_(z.u_), t_(z.t_), h_(z.h_) {}
