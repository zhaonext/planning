...
public:
    ...
    bool IsPointInRectangle(const Vec2d &point) const;
    ...
    bool HasOverlapRectangle(const LineSegment2d &line_segment) const;

    bool GetOverlapRectangle(const LineSegment2d &line_segment) const;

    bool GetIntervalOverlap(const double &a, const double &b,
     ...
     */
    bool ExtremePoints(const double heading, Vec2d *const first,
                       Vec2d *const last) const;
