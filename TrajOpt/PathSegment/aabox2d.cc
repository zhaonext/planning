...
std::string AABox2d::DebugString() const {
    std::string tmp = "aabox2d ( center = " + center_.DebugString() + "  length = " + std::to_string(length_) + "  width = " + std::to_string(width_) + " )";
    return tmp;
}