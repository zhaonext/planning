...
public:
    ...
    /**
     * @brief Reset which takes the center, heading.
     *
     * @param center The center of the rectangular bounding box.
     * @param heading The angle between the x-axis and the heading-axis,
     *        measured counter-clockwise.
     ...
     * @param width The size of the axis perpendicular to the heading-axis.
     */
    void Reset(const Vec2d &center, const double heading, const double length,
               const double width);
     ...
     *
     * @param center The center of the rectangular bounding box.
     * @param cos_heading The cos value of heading.
     * @param sin_heading The sin value of heading.
     * @param length The size of the heading-axis.
     * @param width The size of the axis perpendicular to the heading-axis.
     */
    void ResetPartial(const Vec2d &center, const double cos_heading, const double sin_heading, const double length,
                      const double width);
     ...
     * @param sin_heading The sin value of heading.
     */
    void ResetPartial(const Vec2d &center, const double cos_heading, const double sin_heading);
     ...
     * @return True if they overlap
     */
    bool HasOverlapAABB(const Box2d &box) const;
    ...
    inline double max_x() const { return max_x_; }
    inline double min_x() const { return min_x_; }
    inline double max_y() const { return max_y_; }
    inline double min_y() const { return min_y_; }
...
private:
    ...
    std::vector<Vec2d> corners_{Vec2d(), Vec2d(), Vec2d(), Vec2d()};
